      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <header className="text-center space-y-4 pt-10 pb-6 relative">
          ...
          <div className="flex justify-center mb-6">
            <Link to="/" className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-slate-300 hover:text-white transition-all duration-300 backdrop-blur-md">
